...
Feel free to use your favourite LLM to help you build a mental landscape of the subject. Think of LLMs as an extension of Wikipedia and Google. Do not not copy directly from Wikipedia or Google or LLMs or any other source to the report (unless you explicitly cite your references). Your writing should always show your own understanding. Exercise your own critical thinking.  Ultimately, you are always responsible for what you write. 
